...
This is a simple example based on ISO 19111 and its encoding in ISO 19136. The example provides an implicit transformation which is a translation of coordinates from a local coordinate system to the anchor point specified in the anchor definition. The example does not include rotation and scaling. Based on ISO 19111 and ISO 19136, more complex transformations including rotation and scaling can be expressed as well.
-->
...
xsi:schemaLocation="http://www.opengis.net/citygml/3.0 ../../Schema/core.xsd http://www.opengis.net/citygml/construction/3.0 ../../Schema/construction.xsd http://www.opengis.net/citygml/building/3.0 ../../Schema/building.xsd http://www.opengis.net/citygml/relief/3.0 ../../Schema/relief.xsd">
