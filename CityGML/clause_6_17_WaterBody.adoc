...
In addition, the WaterBody Requirements Class is dependent on the following external OGC and ISO standards:
...
The CityGML WaterBody XML elements are listed in the GML schema http://schemas.opengis.net/citygml/waterbody/3.0/waterBody.xsd[waterBody.xsd^].
