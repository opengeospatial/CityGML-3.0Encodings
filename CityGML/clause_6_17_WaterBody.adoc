...
The CityGML WaterBody XML elements and their corresponding CityGML UML classes are listed in <<water-body-xml-elements>>. In addition, the CityGML WaterBody XML elements are documented in the GML schema http://schemas.opengis.net/citygml/waterbody/3.0/waterBody.xsd[waterBody.xsd^] and in this https://opengeospatial.github.io/CityGML-3.0Encodings/xsd-doc/3.0/waterBody/[XML Schema documentation^].
