...
In addition, the LandUse Requirements Class is dependent on the following external OGC and ISO standards:
...
The CityGML LandUse XML elements are listed in the GML schema http://schemas.opengis.net/citygml/landuse/3.0/landUse.xsd[landUse.xsd^].
