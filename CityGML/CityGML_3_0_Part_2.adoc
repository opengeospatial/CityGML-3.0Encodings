...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/CityGML-2/3.0
|Internal reference number of this OGC(R) document:    21-006
|Version: 0.1
|Category: OGC(R) Implementation Specification
|Editor: Tatjana Kutzner, Carl Stephen Smyth, Claus Nagel, Volker Coors, ... , Charles Heazel, Thomas H. Kolbe
|===
...
|Document subtype:   Encoding Specification
...
include::clause_6_requirements.adoc[]
...
include::annex-examples.adoc[]

include::annex-schema.adoc[]

include::annex-conceptual-model-conformance.adoc[]

include::annex-codelist-usage.adoc[]

include::annex-gml-3.3.adoc[]

include::annex-implementation-decisions.adoc[]
