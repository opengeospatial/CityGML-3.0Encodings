...
In addition, the Relief Requirements Class is dependent on the following external OGC and ISO standards:
...
The CityGML Relief XML elements are listed in the GML schema http://schemas.opengis.net/citygml/relief/3.0/relief.xsd[relief.xsd^].
