...
.Example of a energy consumption pattern composed of atomic timeseries.
...
.Example of a monthly pattern composed of individual CompositeTimeseries  defined by complex energy consumption pattern comosed of atomic timeseries.
