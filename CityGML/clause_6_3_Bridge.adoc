...
In addition, the Bridge Requirements Class is dependent on the following external OGC and ISO standards:
...
The CityGML Bridge XML elements are listed in the GML schema http://schemas.opengis.net/citygml/bridge/3.0/bridge.xsd[bridge.xsd^].
