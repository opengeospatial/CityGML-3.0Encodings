...
In addition, the CityFurniture Requirements Class is dependent on the following external OGC and ISO standards:
...
The CityGML CityFurniture XML elements are listed in the GML schema http://schemas.opengis.net/citygml/cityfurniture/3.0/cityFurniture.xsd[cityFurniture.xsd^].
