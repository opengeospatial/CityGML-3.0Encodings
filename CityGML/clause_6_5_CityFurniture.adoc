...
The CityGML CityFurniture XML elements and their corresponding CityGML UML classes are listed in <<city-furniture-xml-elements>>. In addition, the CityGML CityFurniture XML elements are documented in the GML schema http://schemas.opengis.net/citygml/cityfurniture/3.0/cityFurniture.xsd[cityFurniture.xsd^] and in this link:XML-schema-documentation/cityFurniture.xsd.html[XML Schema documentation^].
...
|===
^|XML Schema Element +
 (link:XML-schema-documentation/cityFurniture.xsd.html[XML Schema documentation^])
^|Conceptual Model +
...
|CityFurniture |«TopLevelFeatureType» https://docs.ogc.org/is/20-010/20-010.html#CityFurniture-section[CityFurniture^]
|ADEOfCityFurniture |«DataType» https://docs.ogc.org/is/20-010/20-010.html#ADEOfCityFurniture-section[ADEOfCityFurniture^]
|===
