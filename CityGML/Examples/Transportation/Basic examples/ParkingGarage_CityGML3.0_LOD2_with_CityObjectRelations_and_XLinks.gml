...
<!--
  ...
  The file contains also an Intersection that is part of the roads "Road2" and "Road3". The intersection is represented only once as part of "Road2" and is linked from "Road3" using an XLink relation.
