...
In addition, the Building Requirements Class is dependent on the following external OGC and ISO standards:
...
The CityGML Building XML elements are listed in the GML schema http://schemas.opengis.net/citygml/building/3.0/building.xsd[building.xsd^].
