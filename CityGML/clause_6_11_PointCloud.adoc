...
The CityGML PointCloud XML elements and their corresponding CityGML UML classes are listed in <<point-cloud-xml-elements>>. In addition, the CityGML PointCloud XML elements are documented in the GML schema http://schemas.opengis.net/citygml/pointcloud/3.0/pointCloud.xsd[pointCloud.xsd^] and in this link:XML-schema-documentation/pointCloud.xsd.html[XML Schema documentation^].
...
|===
^|XML Schema Element +
 (link:XML-schema-documentation/pointCloud.xsd.html[XML Schema documentation^])
^|Conceptual Model +
...
|PointCloud |«FeatureType» https://docs.ogc.org/is/20-010/20-010.html#PointCloud-section[PointCloud^]
|ADEOfPointCloud |«DataType» https://docs.ogc.org/is/20-010/20-010.html#ADEOfPointCloud-section[ADEOfPointCloud^]
|===
