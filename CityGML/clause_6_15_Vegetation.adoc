...
In addition, the Vegetation Requirements Class is dependent on the following external OGC and ISO standards:
...
The CityGML Vegetation XML elements are listed in the GML schema http://schemas.opengis.net/citygml/vegetation/3.0/vegetation.xsd[vegetation.xsd^].
